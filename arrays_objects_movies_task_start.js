...
for (var movie of movies) {
  if (movie.title.toUpperCase() === 'CITIZEN KANE'.toUpperCase()) {
    console.log(`Year of relase: ${movie.year}`);
  }
}
...
for (var movie of movies) {
  ...
  movie.title = lowerTitle;
  console.log(movies);
}

// for (var movie of movies) {
//   director = movie.director
//   movie.director = 'Your Mum'
// }
// console.log(`I heard that ${movie.director} has directed a lot of films`);

for (var movie of movies) {
  if (movie.title === 'black panther') {
    movie.director = 'Your Mum';
    console.log(`I heard that ${movie.director} made the new Black Panther film`);
  }
}